    ...
    <div class="invoice-box">
        <div class="row">
          ...
          <div class="row">
              ...
              أعرض ما يلي: <br>
              أرجو التفضل بالموافقة على منحي وثيقة دوام للعام الدراسي &nbsp; {{$document->description['year']}} &nbsp; &nbsp; الفصل &nbsp; {{$document->description['season']}}
              </p>
          </div>
          ...
          <div class="row d-flex justify-content-end mb-3 mt-2">
            <p>
          ...
          <div class="row">
            <p>
              مطالعة المدرس المختص: {{ $document->description['teacher_review'] }}  
            </p>
          </div>
          <div class="row d-flex justify-content-end mb-2 mt-2">
            <p>
              الاسم والتوقيع: {{ $document->description['teacher_name'] }}
            </p>
          </div>
          <div class="row">
            <p>
