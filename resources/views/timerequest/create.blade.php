  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="form" method="POST" action="/requests/timerequest">
          @csrf
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <input value="{{ old('year') }}" type="text" name="year" class="form-control" {{ auth()->user()->office_id != 4 ? 'readonly' : '' }}>
            ...
            <div class="row">
                <div class="col-10">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" rows="2" name="teacher_review" {{ auth()->user()->office_id != 4 ? 'readonly' : '' }}>{{ old('teacher_review') }}</textarea>
                    {{-- <input value="{{ old('teacher_review') }}" type="text" name="teacher_review" class="form-control" {{ auth()->user()->office_id != 4 ? 'readonly' : '' }}> --}}
              ...
              <div class="row">
                <div class="col">
                    <div class="form-group float-right">
                      ...
                      <br>
                      <input value="{{ old('teacher_name') }}" type="text" name="teacher_name" class="form-control" {{ auth()->user()->office_id != 4 ? 'readonly' : '' }}>
