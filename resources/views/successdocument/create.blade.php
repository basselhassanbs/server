        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form" method="POST" action="/documents/success">
                        @csrf
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('birth_place') }}" type="text" name="birth_place" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('birth_date') }}" type="number" name="birth_date" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('nationality') }}" type="text" name="nationality" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('university_id') }}" type="number" name="university_id" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('success_year') }}" type="text" name="success_year" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('register_year') }}" type="text" name="register_year" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
                            ...
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input value="{{ old('req_id') }}" type="number" name="req_id" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
