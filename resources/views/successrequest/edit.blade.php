      ...
      <div class="card-body">
        ...
        <form class="form" method="POST" action="/requests/{{ $document->id }}/{{ $document->type }}">
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                <label for="student_name">مقدمة الطالب</label>
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                <label for="year">أرجو التفضل بالموافقة على منحي وثيقة ترفع للعام الدراسي</label>
              ...
              <div class="row">
                <div class="col">
                    <div class="form-group float-right">
                      ...
                      <input type="checkbox" class="form-control" value="{{ old('examinations_sign') }}" name="examinations_sign" {{ auth()->user()->office_id != 2 ? 'disabled' : '' }}>
                    </div>
                  </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group float-right">
                      ...
                      <input type="checkbox" class="form-control" value="{{ old('dean_of_theFaculty') }}" name="dean_of_theFaculty" {{ auth()->user()->office_id != 3 ? 'disabled' : '' }}>
                    </div>
                  </div>
            </div>
