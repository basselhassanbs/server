          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <input value="{{ $document->description['average'] }}" type="text" name="average" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
            ...
            <div class="col-4">
                <div class="form-group">
                  ...
                  <input value="{{ $document->description['average_write'] }}" type="text" name="average_write" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input value="{{ $document->description['evaluation'] }}" type="text" name="evaluation" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
          ...
          <div class="row">
            <div class="col-4">
              <div class="form-group">
                ...
                <input value="{{ $document->description['request_id'] }}" type="text" name="request_id" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input value="{{ $document->description['req_date'] }}" type="text" name="req_date" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}>
