    ...
    <div class="invoice-box">
        <div class="row">
          ...
          <div class="row d-flex justify-content-center mb-2">
            <h2 >طلب الحصول على وثيقة إنهاء مقررات</h2>
          </div>
          ...
          <div class="row">
              ...
              <p>
                  مقدمة الطالب &nbsp; {{$document->description['student_shortname']}} &nbsp; &nbsp; بن &nbsp; {{$document->description['father_name']}} &nbsp; &nbsp; والدتي &nbsp; {{$document->description['mother_name']}} &nbsp; &nbsp; السنة &nbsp; {{$document->description['study_year']}} &nbsp; &nbsp; القسم/الشعبة &nbsp; {{$document->description['department']}} &nbsp; &nbsp; الرقم الجامعي &nbsp; {{$document->description['university_id']}} <br>
                  المسجل بالجامعة لأول مرة عام &nbsp; {{$document->description['university_register_year']}} <br>
                  أعرض ما يلي: <br>
                  أرجو التفضل بالموافقة على منحي وثيقة إنهاء مقررات من أجل التسجيل لدرجة الماجستير/دبلوم تأهيل تربوي
              </p>
          </div>
          ...
          <div class="row d-flex justify-content-end mb-2">
            <p>
              اسم الطالب : {{$document->description['student_name']}} <br>
              التوقيع:
            </p>
          </div>
          ...
          <div class="row">
            <p>
              إلى شعبة الامتحانات أصولاً <br>
              {{$document->description['examinations_review']}}
            </p>
          </div>
