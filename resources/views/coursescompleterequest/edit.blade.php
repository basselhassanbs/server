          ...
          <div class="row">
            ...
            <div class="col-4">
              <div class="form-group">
                ...
                <input value="{{ $document->description['mother_name']  }}" type="text" name="mother_name" class="form-control" {{ auth()->user()->office_id != 4 ? 'readonly' : '' }}>
          ...
          <div class="row">
            <div class="col-4">
                <div class="form-group">
                    ...
                    <input value="{{ $document->description['university_register_year']  }}" type="number" name="university_register_year" class="form-control" {{ auth()->user()->office_id != 4 ? 'readonly' : '' }}>
            ...
            <div class="row">
                <div class="col-10">
                  <div class="form-group">
                    ...
                    {{-- <input value="{{ old('examinations_review') }}" type="text" name="examinations_review" class="form-control" {{ auth()->user()->office_id != 2 ? 'readonly' : '' }}> --}}
